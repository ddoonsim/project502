window.addEventListener("DOMContentLoaded", function() {
    ...
    loadEditor("html_top")
        .then(editor => window.editor1 = editor)    // 전역 변수화
...
function callbackFileUpload(files) {
    ...
    const targetTop = document.getElementById("uploaded_file_html_top") ;
    const targetBottom = document.getElementById("uploaded_file_html_bottom") ;
